...
export default function Map(props) {
  ...
  useEffect(() => {
    ...
    kakao.maps.event.addListener(map, "zoom_changed", handleChangeZoom);
    kakao.maps.event.addListener(map, "center_changed", handleChangeCenter);

    props.handlePropsClick();
